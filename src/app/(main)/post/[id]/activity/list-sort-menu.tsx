...
// src/app/(main)/post/[id]/activity/list-sort-menu.tsx
//
// Used by the standalone likes/quotes/reposts list pages (each has its own
// route, unlike the tabbed main activity page), so navigation is a plain
// `${basePath}?sort=...` rather than the tab+postId scheme in sort-menu.tsx.
import { useState } from 'react'
import { useRouter } from 'next/navigation'
import { ChevronDown, Check } from 'lucide-react'

export default function ListSortMenu({ basePath, currentSort }: { basePath: string; currentSort: 'recent' | 'top' }) {
