...
// the familiar "show N more replies" pattern: the first (oldest) reply is
// always visible, the rest sit behind a toggle - all still inline, on this
// same page, never a separate navigation.
    ...
    <div style={{ position: 'relative' }}>
      ...
      {rest.length > 0 && (
        <button
          ...
          style={{
            display: 'flex', alignItems: 'center', gap: 6, marginLeft: 52, marginBottom: 12,
