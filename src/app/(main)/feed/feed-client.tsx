...
export default function FeedClient({ initialPosts, initialCursor }: FeedClientProps) {
  ...
  function getFeedFn(tab: Tab) {
    if (tab === 'for-you')   return getForYouFeedAction
    if (tab === 'following') return getFollowingFeedAction
    return getMutualsFeedAction
  }
  ...
  const emptyMessage = {
    ...
    'mutuals':   { title: 'No mutuals yet',        body: 'When someone follows you back, their posts show up here.' },
  }
