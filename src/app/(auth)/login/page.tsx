    ...
    <AuthCard title="Welcome back" subtitle="Sign in to your Spup account">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div style={{ marginBottom:14 }}>
          ...
          <input {...register('email')} type="email" placeholder="you@email.com" autoComplete="email" inputMode="email" autoFocus style={inp(errors.email?.message)} />
        ...
        <div style={{ marginBottom:22 }}>
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:6 }}>
            ...
            <Link href="/forgot-password" style={{ fontSize:12, color:'#1A9E5F', textDecoration:'none', fontWeight:500 }}>Forgot password?</Link>
          </div>
          <div style={{ position:'relative' }}>
            <input {...register('password')} type={showPw?'text':'password'} placeholder="Your password" autoComplete="current-password" style={{ ...inp(errors.password?.message), paddingRight:44 }} />
      ...
      <p style={{ textAlign:'center', fontSize:14, color:'#44444A', marginTop:20 }}>
        New to Spup?{' '}
        <Link href="/signup" style={{ color:'#1A9E5F', fontWeight:600, textDecoration:'none' }}>Create account</Link>
      </p>
    </AuthCard>
  )
}
