    ...
    <div style={{
      ...
      <footer style={{
        ...
        <p style={{ fontSize: 12, color: 'var(--color-text-muted)', lineHeight: 1.6 }}>
          ...
          <Link href="/terms" style={{ color: 'var(--color-text-secondary)', textDecoration: 'underline' }}>Terms</Link>
          {' '}and{' '}
          <Link href="/privacy" style={{ color: 'var(--color-text-secondary)', textDecoration: 'underline' }}>Privacy Policy</Link>.
        </p>
      </footer>
    </div>
  )
